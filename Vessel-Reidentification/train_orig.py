...
def reid_train(csv_path_train, csv_path_val, train_data_path, val_data_path, mask_path_train, mask_path_val, NB_classes,
    ...
    dataloader_val = DataLoader(dataset_val, batch_size=8, shuffle=False, num_workers=1)
    ...
    torch.save(arcface.W_front, './mapping_weights/Mapping_weights_front.pt')
    torch.save(arcface.W_side, './mapping_weights/Mapping_weights_side.pt')
    torch.save(arcface.W_rear, './mapping_weights/Mapping_weights_rear.pt')
    torch.save(arcface.W_global, './mapping_weights/Mapping_weights_global.pt')
